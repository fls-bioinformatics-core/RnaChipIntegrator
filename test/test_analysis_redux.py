...
class TestFindNearestFeaturesForSummits(unittest.TestCase):
    ...
    def test_find_nearest_features_summits_max_closest(self):
        # Run the analysis
        results = list(find_nearest_features(self.summits,
                                             self.features,
                                             max_closest=3))
...
class TestFindNearestFeaturesForRegions(unittest.TestCase):
    ...
    def test_find_nearest_features_regions_max_closest(self):
        # Run the analysis
        results = list(find_nearest_features(self.peaks,
                                             self.features,
                                             max_closest=3))
...
class TestFindNearestPeaksForSummits(unittest.TestCase):
    ...
    def test_find_nearest_peaks_summits_max_closest(self):
        # Run the analysis
        results = list(find_nearest_peaks(self.features,
                                          self.summits,
                                          max_closest=2))
...
class TestFindNearestPeaksForRegions(unittest.TestCase):
    ...
    def test_find_nearest_peaks_regions_max_closest(self):
        # Run the analysis
        results = list(find_nearest_peaks(self.features,
                                          self.peaks,
                                          max_closest=2))
